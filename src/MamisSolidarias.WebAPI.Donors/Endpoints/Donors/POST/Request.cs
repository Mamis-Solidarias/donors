...
public class Request
{
    ...
    [FromClaim("Id")] public int UserId { get; set; }
}
...
internal class RequestValidator : Validator<Request>
{
    public RequestValidator()
    {
        ...
        RuleFor(t => t.Phone)
            ...
            .MaximumLength(12)
            .When(t => t.Phone is not null).WithMessage("El teléfono no puede tener más de 12 caracteres")
            .NotEmpty()
        ...
        RuleFor(t => t.MercadoPagoEmail)
            .EmailAddress()
            .When(t => t.MercadoPagoEmail is not null)
            .WithMessage("El email de Mercado Pago no tiene un formato válido")
            .MaximumLength(200)
            .When(t => t.MercadoPagoEmail is not null)
